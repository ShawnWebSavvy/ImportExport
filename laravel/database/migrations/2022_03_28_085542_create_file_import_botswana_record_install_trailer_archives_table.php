...
class CreateFileImportBotswanaRecordInstallTrailerArchivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('file_import_botswana_record_install_trailer_archives', function (Blueprint $table) {
            ...
            $table->char('BlockCount', 6)->nullable();
            $table->char('RecordCount', 6)->nullable();
            $table->char('UserHeaderTrailerCount', 6)->nullable();
    ...
    {
        Schema::dropIfExists('file_import_botswana_record_install_trailer_archives');
    }
}
