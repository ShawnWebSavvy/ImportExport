...
class CreateFileImportNamibiaArchivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('file_import_namibia_archives', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('file_import_namibia_archives');
    }
}
