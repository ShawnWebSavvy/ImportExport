...
class CreateFileImportBotswanaRecordInstallHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('file_import_botswana_record_install_headers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('file_import_botswana_record_install_headers');
    }
}
