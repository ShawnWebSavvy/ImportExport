...
class CreateMercantileCapitecTransactionsArchivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mercantile_capitec_transactions_archives', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mercantile_capitec_transactions_archives');
    }
}
