...
class CreateMercantileTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mercantile_transactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mercantile_transactions');
    }
}
