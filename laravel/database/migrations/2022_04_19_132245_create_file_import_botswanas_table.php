...
class CreateFileImportBotswanasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('file_import_botswanas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('file_import_botswanas');
    }
}
