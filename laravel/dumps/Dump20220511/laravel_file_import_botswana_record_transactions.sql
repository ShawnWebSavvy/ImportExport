...
--
-- Table structure for table `file_import_botswana_record_transactions`
--

DROP TABLE IF EXISTS `file_import_botswana_record_transactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `file_import_botswana_record_transactions` (
...
--
-- Dumping data for table `file_import_botswana_record_transactions`
--

LOCK TABLES `file_import_botswana_record_transactions` WRITE;
/*!40000 ALTER TABLE `file_import_botswana_record_transactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `file_import_botswana_record_transactions` ENABLE KEYS */;
UNLOCK TABLES;
