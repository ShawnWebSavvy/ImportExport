...
--
-- Table structure for table `file_import_botswana_record_install_trailers`
--

DROP TABLE IF EXISTS `file_import_botswana_record_install_trailers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `file_import_botswana_record_install_trailers` (
...
--
-- Dumping data for table `file_import_botswana_record_install_trailers`
--

LOCK TABLES `file_import_botswana_record_install_trailers` WRITE;
/*!40000 ALTER TABLE `file_import_botswana_record_install_trailers` DISABLE KEYS */;
/*!40000 ALTER TABLE `file_import_botswana_record_install_trailers` ENABLE KEYS */;
UNLOCK TABLES;
