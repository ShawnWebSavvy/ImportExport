...
--
-- Table structure for table `file_import_botswana_record_contras`
--

DROP TABLE IF EXISTS `file_import_botswana_record_contras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `file_import_botswana_record_contras` (
  ...
  `UserReference` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `file_import_botswana_record_contras`
--

LOCK TABLES `file_import_botswana_record_contras` WRITE;
/*!40000 ALTER TABLE `file_import_botswana_record_contras` DISABLE KEYS */;
/*!40000 ALTER TABLE `file_import_botswana_record_contras` ENABLE KEYS */;
UNLOCK TABLES;
